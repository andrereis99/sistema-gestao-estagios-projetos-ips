...
var config = {
    server: 'g13webapplication-db.database.windows.net',
    database: 'aspnet-G13WebApplication-832BE283-7AF5-4780-BC7F-73205C6B0A06',
    user: 'grupo13',
    password: '123mejmo*',
    options: {
        encrypt: true
...
sgMail.setApiKey('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'); //Api key for sendgrid mailer
app.use(cors());
